...
--include ${HDK_SHELL_DESIGN_DIR}/ip/axi_dma_0/
--include ${HDK_SHELL_DESIGN_DIR}/ip/axi_crossbar_0/
...
# Also include the hdl file and the sim file for more ip
${HDK_SHELL_DESIGN_DIR}/ip/axi_crossbar_0/hdl/axi_crossbar_v2_1_vl_rfs.v
${HDK_SHELL_DESIGN_DIR}/ip/axi_crossbar_0/hdl/axi_register_slice_v2_1_vl_rfs.v
${HDK_SHELL_DESIGN_DIR}/ip/axi_crossbar_0/sim/axi_crossbar_0.v
