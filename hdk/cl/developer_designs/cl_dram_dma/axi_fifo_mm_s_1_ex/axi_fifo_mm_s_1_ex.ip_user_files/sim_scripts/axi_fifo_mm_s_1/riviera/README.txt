...
#
# Generated by export_simulation on Sat May 01 05:44:03 UTC 2021
#
################################################################################
...
'-reset_run' switch to the './axi_fifo_mm_s_1.sh' script.

./axi_fifo_mm_s_1.sh -reset_run
...
./axi_fifo_mm_s_1.sh -noclean_files

For more information on the script, please type './axi_fifo_mm_s_1.sh -help'.
